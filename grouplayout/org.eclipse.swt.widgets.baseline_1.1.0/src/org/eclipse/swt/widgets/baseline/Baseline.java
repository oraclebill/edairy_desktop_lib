...
/**
 * Baseline class used to determine text baseline value of widgets.
 * Singleton.
 * Usage:
 * 		Baseline.getBaseline(someControl)
 * 		Baseline.getBaseline(someControl, controlWidth, controlHeight)
 * @author mitin_aa
 */
public class Baseline {
    ...
    /**
     * Main baseline value fetch method. Basically it fetches baseline value from controls using control's 
     * font metrics and specific info (e.g. top or center alignments of text (I have never seen bottom alignment))
     * then does baseline adjustments. This is very approximate value of baseline we get in this method.
     */
     ...
     * of the component.
     *
     * @param c the Control to get the baseline resize behavior for
	...
	/**
	 * @param control
	 * @return Control's insets as an array of int, where index:
	 *   0 - left side, 
	 *   1 - top side, 
	 *   2 - right side,
	 *   3 - bottom side 
