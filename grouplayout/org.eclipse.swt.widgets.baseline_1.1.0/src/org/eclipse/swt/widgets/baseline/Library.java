...
public class Library {
	...
	/**
	 * Loads the shared library that matches the version of the Java code which is currently running. SWT
	 * shared libraries follow an encoding scheme where the major, minor and revision numbers are embedded in
	 * the library name and this along with <code>name</code> is used to load the library. If this fails,
	 * <code>name</code> is used in another attempt to load the library, this time ignoring the SWT version
	 * encoding scheme.
	 * 
	 * @param name
