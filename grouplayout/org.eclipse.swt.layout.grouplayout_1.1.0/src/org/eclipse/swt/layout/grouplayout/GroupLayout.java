...
import org.eclipse.swt.widgets.baseline.Baseline;
...
public class GroupLayout extends Layout {
     ...
     */
    public void setHonorsVisibility(Control component,
...
/*    public void invalidateLayout(Composite parent) {
    ...
    private Point adjustSize(int width, int height) {
        ...
        return new Point(width + insets[0] + insets[2],
                height + insets[1] + insets[3]);
    }
     ...
     */
    private boolean areParallelSiblings(Control source, Control target,
            int axis) {
    ...
    public class SequentialGroup extends Group {
         ...
         * @return this <code>SequentialGroup</code>
         */
        public SequentialGroup add(Control component, int min, int pref,
                int max) {
        ...
        public SequentialGroup add(boolean useAsBaseline,
                Control component, int min, int pref, int max) {
         ...
         * @see LayoutStyle
         */
        public SequentialGroup addPreferredGap(Control comp1,
                Control comp2,
                int type) {
...
//                        }
    ...
    public class ParallelGroup extends Group {
         ...
         * @return this <code>SequentialGroup</code>
         */
        public ParallelGroup add(Control component, int min, int pref,
                int max) {
         ...
         * @return this <code>Group</code>
         */
        public ParallelGroup add(int alignment, Control component, int min,
                int pref, int max) {
            checkChildAlignment(alignment);
    ...
    private final class ComponentSpring extends Spring {
        ...
        private ComponentSpring(Control component, int min, int pref,
                int max) {
...
//            }
        ...
        void setComponent(Control component) {
            this.component = component;
        }
    ...
    private final class PaddingSpring extends Spring {
        ...
        PaddingSpring(Control source, Control target, int type,
                boolean canGrow) {
            this.source = source;
            this.target = target;
            this.type = type;
        ...
        private int getPadding(int axis) {
            ...
            return getLayoutStyle0().getPreferredGap(source.getClass(), source.getStyle(),
                    target.getClass(), target.getStyle(), type, position);
        }
    }
    ...
    private class AutopaddingSpring extends Spring {
        ...
        private int calculatePadding(LayoutStyle p, int position,
            ...
            if (delta >= 0) {
				...
				int padding = p.getPreferredGap(sourceControl.getClass(), sourceControl.getStyle(), targetControl.getClass(), targetControl.getStyle(), type, position);
                if (padding > delta) {
...
//                    }
        ...
        private int updateSize(LayoutStyle p, ComponentSpring sourceSpring,
			...
			int padding = p.getContainerGap(
				        control.getClass(), control.getStyle(), position);
//            int padding = 10;
